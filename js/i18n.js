...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    en: {
      ...
      quick_import: '⚡ Quick Import', import_csv: 'Import CSV', import_photo: 'Choose Photo',
    ...
    ja: {
      ...
      quick_import: '⚡ クイックインポート', import_csv: 'CSV取込', import_photo: '写真を選択',
